...
contract MyNFT is ERC721URIStorage {
    ...
    event NFTMinted(uint256 id,string uri,uint256 cost,bool isForSale,address owner);
    ...
    function createCollectible(string memory _tokenURI,uint256 _cost,bool _isForSale) public payable returns (uint256) {
    ...
    function mintWithToken(string memory _tokenURI,uint256 _cost,bool _isForSale) public returns (uint256) {
